    ...
    def load_orders(self):
        with self.dwh.connection() as conn:
            ...
            for order_raw in load_queue:
                ...
                self.log.info(str(order_raw) + '___!___' + str(restaurant[0]) +' ____!!____ ' +  str(timestamp.id) +' ____!!____ ' + str(user[0]))
                order_to_load = self.parse_order(order_raw, restaurant[0], timestamp.id, user[0])
