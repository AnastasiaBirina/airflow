...
from examples.dds.init_schema_dag.schema_init import SchemaDdl
...
@dag(
    ...
    tags=['sprint5', 'dds', 'schema', 'ddl', 'example'],  # Теги, используются для фильтрации в интерфейсе Airflow.
    is_paused_upon_creation=True  # Остановлен/запущен при появлении. Сразу запущен.
)
def sprint5_example_dds_init_schema_dag():
...
dds_init_schema_dag = sprint5_example_dds_init_schema_dag()  # noqa
